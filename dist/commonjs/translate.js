...
var translate = function (language) { return ({
    ...
    getTranslation: function (msgid, n, context, defaultPlural, languageKey) {
        ...
        var untranslated = defaultPlural && plurals_1.default.getTranslationIndex(languageKey, n) > 0 ? defaultPlural : msgid;
        ...
        var translationIndex = plurals_1.default.getTranslationIndex(languageKey, n);
