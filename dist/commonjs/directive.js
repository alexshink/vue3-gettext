...
var updateTranslation = function (language, el, binding, vnode) {
    ...
    var translation = translate_1.default(language).getTranslation(msgid, translateN, translateContext, isPlural ? translatePlural : null, language.current);
    var context = Object.assign(binding.instance, binding.value);
    var msg = interpolate_1.default(language)(translation, context, null, disableHtmlEscaping);
    el.innerHTML = msg;
};
/**
